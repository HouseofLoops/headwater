...
class PlaceResult(BaseModel):
    ...
    plus_code: str | None = Field(None, description="Google Plus Code for precise location", examples=["85HQ+XX Portland, Oregon"])
    google_maps_url: str | None = Field(None, description="Direct link to Google Maps page")

    # Business Classification
    category: str | None = Field(None, description="Primary business category", examples=["Coffee shop", "Restaurant", "Hotel"])
...
class PlaceLookupRequest(BaseModel):
    ...
    place_id: str | None = Field(None, description="Google Place ID (CID)", examples=["0x89c259af18b60947:0x8c5e3c1d36e36e0a"])
...
class PhotosRequest(BaseModel):
    ...
    category: str | None = Field(None, description="Photo category filter", examples=["all", "food", "interior", "exterior", "menu"])
